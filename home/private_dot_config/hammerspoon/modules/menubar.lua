...
function menu:analyzeAndSetMenubarIcon()
  ...
  local realPrecent = math.floor(100 * batt_info.capacity / batt_info.maxCapacity + 0.3)
  ...
  print(string.format("Battery: (%d)[%d] (%d/%d)", batt_info.percentage, realPrecent, batt_info.capacity, batt_info.maxCapacity))

...
alias pc="podman compose -f ${XDG_CONFIG_HOME}/compose/develop-compose.yml"
alias mvfilter='rsync -a --remove-source-files --exclude="opencollection.yml" --exclude="environments"'
